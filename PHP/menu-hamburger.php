<?php
    ...
    echo '<div class="navi_item"><a href=""><i class="fa-solid fa-anchor" style="color: #ffffff;"></i></a></div>';
    echo '<div class="navi_item"><a href=""><i class="fa-solid fa-user-group" style="color: #aed6f4;"></i></a></div>';
    echo '<div class="navi_item"><a href=""><i class="fa-regular fa-envelope" style="color: #5291ff;"></i></a></div>';
    echo '<div class="navi_item"><a href=""><i class="fa-solid fa-arrow-right-from-bracket" style="color: #0b5fef;"></i></a></div>';
    echo '</div>';
    echo '</header>';
