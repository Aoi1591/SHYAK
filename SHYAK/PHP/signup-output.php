...
try {
    if (isset($_GET['username']) && isset($_GET['password']) && isset($_GET['choice'])) { 
        ...
        if ($existingUser && $existingUser['user_name'] === $_GET['username']) {
            ...
            if ($pass_row && password_verify($_GET['password'], $pass_row['hash_pass']) && $existingUser['country_id'] === $_GET['choice']) {
